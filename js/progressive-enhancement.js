...
$( document ).ready( function($){
        ...
        $section.find( 'ul.itemizedlist li' ).each( function( idx, each_li ) {
            ...
            switch( each_li_text ) {
                case 'balixo':
                    ...
                    $each_li.html( '<div class="github-widget" data-repo="BaliAutomation/' + each_li_text + '"></div>' );
                    break;
            }
        } );
    }
    ...
    function get_help( $section ) {
        ...
        if( false ) { // DEACTIVATED
            var stack_search_api = 'https://api.stackexchange.com/2.1/search?order=desc&sort=activity&tagged=balixo&site=stackoverflow'
